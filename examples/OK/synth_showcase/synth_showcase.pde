...
void setup() {
  ...
  logToScreen("System Initialized.", 0);
    ...
    harmonicPartials.put("Organ", new float[]{1f, 0.5f, 0.3f, 0.2f});
    instrumentMap.put("Bell", "ADDITIVE");
    additiveConfigs.put("Bell", Arrays.asList(new SynthComponent("SINE", 1f, 0.8f), new SynthComponent("TRIANGLE", 2.76f, 0.4f), new SynthComponent("SQUARE", 5.4f, 0.2f)));

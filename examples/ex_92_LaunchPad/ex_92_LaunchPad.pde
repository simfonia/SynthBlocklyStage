...
void noteOn(int channel, int pitch, int velocity, String bus_name) {
  ...
  if (bus_name.equals("LaunchPad")) {
  if (floatVal(pitch) == floatVal(112)) {
    playBuiltinDrum("KICK", floatVal(velocity));
    if (midiBusses.containsKey("LaunchPad")) midiBusses.get("LaunchPad").sendNoteOn((int)floatVal(0), (int)floatVal(112), (int)floatVal(15));
  } else if (floatVal(pitch) == floatVal(113)) {
    playBuiltinDrum("SNARE", floatVal(velocity));
    if (midiBusses.containsKey("LaunchPad")) midiBusses.get("LaunchPad").sendNoteOn((int)floatVal(0), (int)floatVal(113), (int)floatVal(63));
  } else if (floatVal(pitch) == floatVal(114)) {
    playBuiltinDrum("CH", floatVal(velocity));
    if (midiBusses.containsKey("LaunchPad")) midiBusses.get("LaunchPad").sendNoteOn((int)floatVal(0), (int)floatVal(114), (int)floatVal(60));
  } else if (floatVal(pitch) == floatVal(115)) {
    playBuiltinDrum("OH", floatVal(velocity));
    if (midiBusses.containsKey("LaunchPad")) midiBusses.get("LaunchPad").sendNoteOn((int)floatVal(0), (int)floatVal(115), (int)floatVal(62));
  } else if (floatVal(pitch) == floatVal(116)) {
    { 
      Object dVal = "4n";
      float ms = (dVal instanceof Number) ? ((Number)dVal).floatValue() : durationToMs(dVal.toString());
      playChordByNameInternal("Piano", "Dm7", ms, floatVal(velocity));
    }
    if (midiBusses.containsKey("LaunchPad")) midiBusses.get("LaunchPad").sendNoteOn((int)floatVal(0), (int)floatVal(116), (int)floatVal(45));
  } else if (floatVal(pitch) == floatVal(117)) {
    { 
      Object dVal = "4n";
      float ms = (dVal instanceof Number) ? ((Number)dVal).floatValue() : durationToMs(dVal.toString());
      playChordByNameInternal("Piano", "G7", ms, floatVal(velocity));
    }
    if (midiBusses.containsKey("LaunchPad")) midiBusses.get("LaunchPad").sendNoteOn((int)floatVal(0), (int)floatVal(117), (int)floatVal(46));
  } else if (floatVal(pitch) == floatVal(118)) {
    { 
      Object dVal = "4n";
      float ms = (dVal instanceof Number) ? ((Number)dVal).floatValue() : durationToMs(dVal.toString());
      playChordByNameInternal("Piano", "CM7", ms, floatVal(velocity));
    }
    if (midiBusses.containsKey("LaunchPad")) midiBusses.get("LaunchPad").sendNoteOn((int)floatVal(0), (int)floatVal(118), (int)floatVal(47));
  } else if (floatVal(pitch) == floatVal(119)) {
    { 
      Object dVal = "4n";
      float ms = (dVal instanceof Number) ? ((Number)dVal).floatValue() : durationToMs(dVal.toString());
      playChordByNameInternal("Piano", "A7", ms, floatVal(velocity));
    }
    if (midiBusses.containsKey("LaunchPad")) midiBusses.get("LaunchPad").sendNoteOn((int)floatVal(0), (int)floatVal(119), (int)floatVal(44));
  }
...
void noteOff(int channel, int pitch, int velocity, String bus_name) {
  ...
  if (bus_name.equals("LaunchPad")) {
  if (midiBusses.containsKey("LaunchPad")) midiBusses.get("LaunchPad").sendNoteOff((int)floatVal(0), (int)floatVal(pitch), (int)floatVal(0));

  }
    currentInstrument = backup; midiKeysHeld.remove(pitch);
  } else {   if (bus_name.equals("LaunchPad")) {
  if (midiBusses.containsKey("LaunchPad")) midiBusses.get("LaunchPad").sendNoteOff((int)floatVal(0), (int)floatVal(pitch), (int)floatVal(0));
...
void setup() {
  ...
  if (!instrumentADSR.containsKey("Piano")) instrumentADSR.put("Piano", new float[]{defAdsrA, defAdsrD, defAdsrS, defAdsrR});
    ...
    instrumentADSR.put("Piano", new float[]{(float)0.01, (float)0.1, (float)0.5, (float)0.5});
    stageBgColor = color(0, 0, 0);
  stageFgColor = color(52, 152, 219);
  adsrState = 0;
  ...
  cp5.addSlider("fgHue").setPosition(20, 555).setSize(150, 15).setRange(0, 255).setValue(144.6).setCaptionLabel("FG COLOR");
  ...
  if (surface.getNative() instanceof java.awt.Canvas) { ((java.awt.Canvas)surface.getNative()).requestFocus(); }
    MidiBus.list();
    midiBusses.put("LaunchPad", new MidiBus(this, 0, 3, "LaunchPad"));
    bpm = floatVal(105);
    ...
    logToScreen(String.valueOf("LaunchPad Drum & Chord Ready!"), 0);
}

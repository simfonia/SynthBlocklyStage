  ...
  new Thread(new Runnable() {
    public void run() {
      ...
      for (int i=0; i<Math.min(steps.length, 16); i++) {
        ...
        if (!token.equals("-")) {
          if (instrumentMap.getOrDefault("Clap", "").equals("DRUM")) { if (token.equalsIgnoreCase("x")) { float volScale = instrumentVolumes.getOrDefault("Clap", 1.0f); samplerGainMap.get("Clap").setValue(map(floatVal(100) * volScale, 0, 127, -40, 0)); samplerMap.get("Clap").trigger(); } }
          else { if (false) { if (token.equals("x")) token = "C"; if (chords.containsKey(token)) playChordByNameInternal("Clap", token, noteDur * 0.9f, floatVal(100)); else { int midi = noteToMidi(token); if (midi >= 0) playNoteForDuration("Clap", midi, floatVal(100), noteDur * 0.9f); } }
          else { if (token.equalsIgnoreCase("x")) playNoteForDuration("Clap", 60, floatVal(100), noteDur * 0.8f); else { int midi = noteToMidi(token); if (midi >= 0) playNoteForDuration("Clap", midi, floatVal(100), noteDur * 0.9f); } } }
        }
  ...
  new Thread(new Runnable() {
    public void run() {
      ...
      for (int i=0; i<Math.min(steps.length, 16); i++) {
        ...
        float noteDur = stepMs * sustainSteps;
        if (!token.equals("-")) {
          if (instrumentMap.getOrDefault("Piano", "").equals("DRUM")) { if (token.equalsIgnoreCase("x")) { float volScale = instrumentVolumes.getOrDefault("Piano", 1.0f); samplerGainMap.get("Piano").setValue(map(floatVal(100) * volScale, 0, 127, -40, 0)); samplerMap.get("Piano").trigger(); } }
          else { if (true) { if (token.equals("x")) token = "C"; if (chords.containsKey(token)) playChordByNameInternal("Piano", token, noteDur * 0.9f, floatVal(100)); else { int midi = noteToMidi(token); if (midi >= 0) playNoteForDuration("Piano", midi, floatVal(100), noteDur * 0.9f); } }
          else { if (token.equalsIgnoreCase("x")) playNoteForDuration("Piano", 60, floatVal(100), noteDur * 0.8f); else { int midi = noteToMidi(token); if (midi >= 0) playNoteForDuration("Piano", midi, floatVal(100), noteDur * 0.9f); } } }
        }
        try { Thread.sleep((long)stepMs); } catch (Exception e) {}
      }
    }
  ...
  new Thread(new Runnable() {
    public void run() {
      ...
      for (int i=0; i<Math.min(steps.length, 16); i++) {
        ...
        float noteDur = stepMs * sustainSteps;
        if (!token.equals("-")) {
          if (instrumentMap.getOrDefault("Bass", "").equals("DRUM")) { if (token.equalsIgnoreCase("x")) { float volScale = instrumentVolumes.getOrDefault("Bass", 1.0f); samplerGainMap.get("Bass").setValue(map(floatVal(100) * volScale, 0, 127, -40, 0)); samplerMap.get("Bass").trigger(); } }
          else { if (false) { if (token.equals("x")) token = "C"; if (chords.containsKey(token)) playChordByNameInternal("Bass", token, noteDur * 0.9f, floatVal(100)); else { int midi = noteToMidi(token); if (midi >= 0) playNoteForDuration("Bass", midi, floatVal(100), noteDur * 0.9f); } }
          else { if (token.equalsIgnoreCase("x")) playNoteForDuration("Bass", 60, floatVal(100), noteDur * 0.8f); else { int midi = noteToMidi(token); if (midi >= 0) playNoteForDuration("Bass", midi, floatVal(100), noteDur * 0.9f); } } }
        }
        try { Thread.sleep((long)stepMs); } catch (Exception e) {}
      }
    }
  ...
  new Thread(new Runnable() {
    public void run() {
      ...
      for (int i=0; i<Math.min(steps.length, 16); i++) {
        ...
        float noteDur = stepMs * sustainSteps;
        if (!token.equals("-")) {
          if (instrumentMap.getOrDefault("Kick", "").equals("DRUM")) { if (token.equalsIgnoreCase("x")) { float volScale = instrumentVolumes.getOrDefault("Kick", 1.0f); samplerGainMap.get("Kick").setValue(map(floatVal(150) * volScale, 0, 127, -40, 0)); samplerMap.get("Kick").trigger(); } }
          else { if (false) { if (token.equals("x")) token = "C"; if (chords.containsKey(token)) playChordByNameInternal("Kick", token, noteDur * 0.9f, floatVal(150)); else { int midi = noteToMidi(token); if (midi >= 0) playNoteForDuration("Kick", midi, floatVal(150), noteDur * 0.9f); } }
          else { if (token.equalsIgnoreCase("x")) playNoteForDuration("Kick", 60, floatVal(150), noteDur * 0.8f); else { int midi = noteToMidi(token); if (midi >= 0) playNoteForDuration("Kick", midi, floatVal(150), noteDur * 0.9f); } } }
        }
        try { Thread.sleep((long)stepMs); } catch (Exception e) {}
      }
    }

(function (Blockly) {
  ...
  Object.assign(Blockly.Msg, {
    ...
    "SB_SET_PANNING_MESSAGE": "設定樂器 %1 相位 %2 (-1~1)",
    ...
    "AUDIO_SET_INSTRUMENT_VOLUME": "設定樂器 %1 音量為 %2 %",
    ...
    "AUDIO_TRIGGER_SAMPLE": "播放單音 %1 音符 %2 力度 %3",
    "AUDIO_TRIGGER_SAMPLE_TOOLTIP": "播放單一音符或擊奏。範例：'C4' (預設四分), 'X' (擊奏), 'C4H' (二分音符)。時值後綴：W(全), H(二分), Q(四分), E(八分), S(十六分)。",
    "HELP_LANG_SUFFIX": "_zh-hant.html",
    "HELP_HINT": "\n按右鍵選擇「說明」了解更多用法。",
    "AUDIO_PLAY_NOTE": "目前的樂器 演奏音符 音高 %1 力度 %2",
    "AUDIO_STOP_NOTE": "目前的樂器 停止演奏音符 (音高 %1)",
    "AUDIO_PLAY_NOTE_TOOLTIP": "讓指定樂器開始播放一個持續音（不自動結束）。通常配合 MIDI 按下事件使用。",
    "AUDIO_STOP_NOTE_TOOLTIP": "讓指定樂器停止播放特定音高。通常配合 MIDI 放開事件使用。",
    "AUDIO_PLAY_MELODY": "播放旋律 樂器 %1 %2 樂譜 %3",
    "AUDIO_PLAY_MELODY_TOOLTIP": "按照清單順序演奏。支援多行、音符 (C4, D4) 與和弦 (CM7, G7)。",
    "AUDIO_TONE_LOOP": "每隔 %1 無限反覆演奏 %2",
    "AUDIO_RHYTHM_SEQUENCE": "步進音序器 %1 樂器 %2 力度 %6 模式 %3 第 %4 小節 節奏 %5",
    ...
    "AUDIO_PLAY_CHORD_BY_NAME": "播放和弦 %1 時值 %2 力度 %3",
    "SB_PLAY_DRUM_MESSAGE": "播放電子鼓聲 %1 力度 %2",
